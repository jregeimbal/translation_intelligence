...
void main() {
  test('DebouncedMessageDispatcher dispatches only the latest queued message', () async {
  ...
  test('DebouncedMessageDispatcher can dispatch successive messages over time', () async {
    final received = <String>[];
    final dispatcher = DebouncedMessageDispatcher(
