...
/// Lightweight stub of GroupController for widget tests. Avoids plugins
/// and network calls while allowing manual control of state.
class TestGroupController extends ChangeNotifier implements GroupController {
  TestGroupController({
  ...
  bool get hasSupportedTargetLanguage {
    return GroupController.supportedLanguages.contains(_targetLanguage);
  }
