...
/// A fake [GroupChatController] for Patrol e2e tests. Avoids real mic/network
/// access while allowing tests to programmatically inject speech results.
class FakeGroupChatController extends ChangeNotifier
    implements GroupChatController {
  FakeGroupChatController({bool speechEnabled = true})
